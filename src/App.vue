<template>
	<el-config-provider :locale="zhCn">
		<div class="w-full h-screen overflow-x-hidden overflow-y-auto font-cyber">
			<el-scrollbar>
				<!-- 赛博朋克导航栏 -->
				<div class="cyber-nav w-full h-16 sticky left-0 top-0 z-10">
				...
				<!-- 主内容区域 -->
				<div class="min-h-[calc(100vh-64px-64px)] overflow-auto relative">
					<router-view />
					<!-- 赛博朋克特效 -->
					<cyber-effects />
				</div>
				...
				<!-- 赛博朋克页脚 -->
				<div class="w-full h-16 flex items-center justify-center cyber-text-dim text-sm border-t border-cyber-border">
					<div class="flex items-center space-x-2">
